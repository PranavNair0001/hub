...
def get_missing_files():    # Utility function to get list of missing artifact files
  ...
  ignorableActionTypes = ['create_driver_artifact']    # Actions in spec.json for which jar/config files is only logged as warning not error. Eg: hydrator-pipeline-mysql-to-bigquery/1.1.1/mysql-connector-java.json
